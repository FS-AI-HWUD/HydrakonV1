#ifndef INCLUDE_HYDRAKON_CAN_HPP_
#define INCLUDE_HYDRAKON_CAN_HPP_
...
class HydrakonCanInterface : public rclcpp::Node {
 ...
 private:
   ...
   */
  hydrakon_can::msg::VehicleCommand makeVehicleCommandMessage();
...
#endif  // INCLUDE_HYDRAKON_CAN_HPP_
